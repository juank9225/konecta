...
<head>
    ...
    <script src="{{asset('js/toastr.min.js?v=2')}}"></script>
    ...
    <div id="app">
        <div class="wrapper">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="Productos/todas"
                                            class="{{ Request::path() === 'Productos/todas' ? 'nav-link active' : 'nav-link' }}">
            ...
            <footer class="main-footer">
                <!-- NO QUITAR -->
                <strong>juan carlos salcedo baldovino
